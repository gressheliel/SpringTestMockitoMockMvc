...
public class MockInjectMocksAnnotationTest {
    ...
    @Order(1)
    @DisplayName("01. When & Verify @Mock, @InjectMocks")
    @Test
    ...
    @Order(2)
    @DisplayName("02. Find Gpa @Mock, @InjectMocks")
    @Test
    ...
    @Order(3)
    @DisplayName("03. Not Null  @Mock, @InjectMocks")
    @Test
    ...
    @Order(4)
    @DisplayName("04. Throw runtime error @Mock, @InjectMocks")
    @Test
    ...
    @Order(5)
    @DisplayName("05.Multiple Stubbing, First call throws an exception the next calls don't @Mock, @InjectMocks")
    @Test
